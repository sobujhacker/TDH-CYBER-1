...
ha = current.day
today = date.today()
os.system('xdg-open https://t.me/EHC99SOBUJ ')
import os
os.system("pkg install espeak")
#__________TDH CYBER SOBUJ
print("walcome to SEE MORE TDH CYBER SOBUJ")
logo = ("""
    \033[38;5;46m   _____ ____  ____  __  __    __
   \033[38;5;46m  / ___// __ \/ __ )/ / / /   / /
  \033[38;5;46m  \__ \/ / / / __  / / / /_  / / 
 \033[38;5;46m ___/ / /_/ / /_/ / /_/ / /_/ /  
...
def xxr():
    ...
    with ThreadPool(max_workers=70) as manshera:
        ...
        tl = str(len(user))
        print('\033[38;5;46m══════════════════════════════════')
        print('\033[38;5;46m𝗧𝗗𝗛 𝗦𝗢𝗕𝗨𝗝 𝗖𝗬𝗕𝗘𝗥')
        print('\033[38;5;46m══════════════════════════════════')
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m𝗧𝗗𝗛 𝗦𝗢𝗕𝗨𝗝\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m𝗧𝗗𝗛 𝗦𝗢𝗕𝗨𝗝 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
...
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m𝗧𝗗𝗛 𝗦𝗢𝗕𝗨𝗝𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;47m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m𝗧𝗗𝗛 𝗦𝗢𝗕𝗨𝗝 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;47m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
...
#______𝑬𝑴𝑶𝑱𝑰-𝑪𝑹𝑲-𝑺𝒀𝑺𝑻𝑬𝑴👇👇👇👇 
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}🦋⃟𝕊𝕆𝔹𝕌𝕁✮⃝𝕋𝔻ℍ𝄟⃝\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
